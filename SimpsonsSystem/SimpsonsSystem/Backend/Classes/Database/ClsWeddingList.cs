...
namespace SimpsonsSystem.Backend.Classes
{
    public class ClsWeddingList:IDisposable
    {
        ...
        public ClsWeddingList(string _clientTitle,string _clientSurname,string _clientForename,long _clientTelNo,string _clientPostCode,DateTime _dateToFinish)
        {
        ...
        private long clientTelNo;
        private string clientPostCode;
        private DateTime dateToFinish;
        #endregion
        #region Public Properties
        public long ClientTelNo{get=>clientTelNo;set=>clientTelNo=value;}
