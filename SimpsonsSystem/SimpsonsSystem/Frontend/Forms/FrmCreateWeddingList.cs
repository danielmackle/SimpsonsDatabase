...
namespace SimpsonsSystem.Frontend.Forms
{
    public partial class FrmCreateWeddingList:Form
    {
        ...
        List<Backend.Classes.ClsStock>stockListLeft=new();
        List<Backend.Classes.ClsStock>stockListRight=new();
        readonly List<int>listAmount=new();
        List<Backend.Classes.ClsWeddingList>listEdit=new();
        int amountToMove=0;
        bool toRight=true;
        int mode = 0;
        #endregion
        ...
        private void FillLbx()
        {
            ...
            stockListLeft=sDBA.GetStockObjects(); //get all registers in a big list as ClsStock and keep in memory for later
        ...
        private void SearchSelected(object sender, EventArgs e)
        {
            ...
            foreach (Backend.Classes.ClsStock sl in stockListRight)
            {
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        lbxSelected.Items.Add(stk.StockName + " | " + sDBA.GetManufacturerName(stk.ManufacturerId) + "| £" + stk.StockPrice + " | " + listAmount[lbxSelected.SelectedIndex]+ " to be Added");
                        lbxSelected.Items.RemoveAt(lbxSelected.SelectedIndex);
                    }
                }
            }
        ...
        private void Confirm(object sender,EventArgs e)
        {
            try
            {
                ...
                long _telNo = Convert.ToInt64(tbxTelNo.Text);
                ...
                if (mode != 2)
                {
                    ...
                    using Backend.Classes.ClsWeddingList wl = new(_title, _surname, _forename, _telNo, _postcode, dateEnd);
        ...
        {
            using Backend.Database.WeddingListDBAccess wDBA=new(db);
            try
            {
        ...
        private void FillEverything(object sender,EventArgs e)
        {
            ...
            Backend.Database.WeddingListDBAccess wDBA = new(db);
            Backend.Database.StockDBAccess sDBA = new(db);
            Backend.Classes.ClsWeddingList wl;
            cbFinished.Checked=false;
            wl = listEdit[lbxEdit.SelectedIndex];
        ...
        private void Delete(object sender,EventArgs e)
        {
            if(cbxDelete.Checked)
            {
                ...
                lblSearchHeld.Visible=false;
                lblSearchSelected.Visible=false;
                tbxSearchHeld.Visible=false;
                tbxSearchSelected.Visible=false;
            ...
            else
            {
                ...
                lblSearchHeld.Visible = true;
                lblSearchSelected.Visible = true;
                tbxSearchHeld.Visible = true;
                tbxSearchSelected.Visible = true;
                btnConfirm.Text="Confirm Edit";
                mode = 1;
            }
        }
        ...
        private void ApplyFilter(object sender, EventArgs e)
        {
            ...
            {
                stockListLeft = sDBA.GetStockObjects();
                foreach (Backend.Classes.ClsStock sl in stockListLeft)
                {
                    lbxStock.Items.Add(sl.StockName + "|" + sDBA.GetManufacturerName(sl.ManufacturerId) + "|£" + sl.StockPrice + "|" + sl.AmountHeld + " Currently Held");
                }
